...
public class MyDefaultTableExpiration extends DefaultTableModel{
	
	List<Stock> stocks ;

	public HashSet<Stock> modified ;
	private String[] columnNames = {"Nom", "Date de péremption", "Quantité expiré"};	


	public MyDefaultTableExpiration(List<Stock> stocks) {
		super();
		this.stocks = stocks;
