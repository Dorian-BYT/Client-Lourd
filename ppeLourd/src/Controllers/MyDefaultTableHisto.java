...
public class MyDefaultTableHisto extends DefaultTableModel{
	
	List<Stock> stocks ;

	public HashSet<Stock> modified ;
	private String[] columnNames = {"Médicament", "idCommande", "Quantité"};	


	public MyDefaultTableHisto(List<Stock> stocks) {
		super();
		this.stocks = stocks;
